...
class CreateKudoTemplateMasterDetailsTable extends Migration {
	...
	public function up()
	{
		Schema::create('kudo_template_master_details', function(Blueprint $table)
		{
	...
	{
		Schema::drop('kudo_template_master_details');
	}
